...
path = '/home/jmlv/workspace/T-CONV/data/'
...
taxi_id_size = 448#436 #440 for 400k  #448 for 1700k
...
if tvt:
    ...
    # `wc -l train.csv` - 1
    train_size = 1710670 #40000    # 800000 - 1  #1710670 

    # `cut -d, -f 3 train.csv test.csv | sort -u | wc -l` - 2
    origin_call_size = 57125 #4163 #4163  #21577  #34413 # 57125 # include 0 ("no origin_call")

    # As printed by csv_to_hdf5.py
    origin_call_train_size = 57106 #4200# 4113 #34385 for 80k  #57106

    if '--largevalid' in sys.argv:
        valid_set = 'cuts/large_valid'
    else:
        valid_set = 'cuts/test_times_0'  #test_times_0'
